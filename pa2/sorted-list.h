...
//Moved these up top so they can be used in the SortedList struct
 ...
 */
 ...
 //please note the typedefs for the comparator and destroyer function were moved
 //they are above the declaration of the sorted list type
